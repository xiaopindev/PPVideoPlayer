...
#ifndef NELivePlayerDef_h
#define NELivePlayerDef_h
 ...
 * 回调的视频数据格式
 */
typedef NS_ENUM(NSInteger, NELPVideoFormatE) {
    /**
     * YUV420
     */
    NELP_YUV420 = 1,
 ...
 * 密钥校验结果
 */
typedef NS_ENUM(NSInteger, NELPKeyCheckResult) {
    /**
     * 没有加密
     */
    NELP_NO_ENCRYPTION                  = 0,
    /**
     * 密钥正确
     */
    NELP_ENCRYPTION_CHECK_OK            = 1,
    /**
     * 协议不支持
     */
    NELP_ENCRYPTION_UNSUPPORT_PROTOCAL  = 2,
    /**
     * 密钥错误
     */
    NELP_ENCRYPTION_KEY_CHECK_ERROR     = 3,
    /**
     * 输入错误
     */
    NELP_ENCRYPTION_INPUT_INVALIED      = 4,
    /**
     * 获取密钥超时
     */
    NELP_ENCRYPTION_GET_KEY_TIMEOUT     = 5,
    /**
     * 未知错误
     */
    NELP_ENCRYPTION_UNKNOWN_ERROR       = 6,
};
